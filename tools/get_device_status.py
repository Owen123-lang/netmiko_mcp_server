...
def get_device_status() -> Dict[str, Any]:
    ...
    try:
        with CiscoDeviceConnector(DEVNET_DEVICE) as connector:
            ...
            hostname_output = connector.execute_command(
        ...
        return {"success": False, "error": f"Failed to get device status: {str(e)}"}
...
def get_device_uptime() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"Failed to get uptime: {str(e)}"}
...
def get_memory_cpu_usage() -> Dict[str, Any]:
    ...
    try:
        with CiscoDeviceConnector(DEVNET_DEVICE) as connector:
            ...
            memory_output = connector.execute_command(
