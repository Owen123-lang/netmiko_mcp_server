...
def get_running_config(filter_keyword: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"Failed to get running config: {str(e)}"}
...
def get_interface_config(interface_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"Failed to get interface config: {str(e)}"}
    ...
    try:
        with CiscoDeviceConnector(DEVNET_DEVICE) as connector:
            ...
            if output:
                ...
                return {"success": False, "error": "No startup configuration found"}

    except Exception as e:
        return {"success": False, "error": f"Failed to get startup config: {str(e)}"}
    ...
    try:
        with CiscoDeviceConnector(DEVNET_DEVICE) as connector:
            ...
            if output is not None:
                ...
                return {"success": False, "error": "Failed to compare configurations"}

    except Exception as e:
        return {"success": False, "error": f"Failed to compare configs: {str(e)}"}
